...
//        @Override boolean
//        filter( Entry entry ) {
//            return( entry.is_favorite() == m_f_has );
//        }
//
//        @Override void
//        get_as_string( StringBuilder string ) {
...
//    }
    ...
    FiltererContainer(long nativePtr) { super(null, null); mNativePtr = nativePtr; }
...
//    }
    ...
    @Override boolean
    is_container() { return true; }

    String
    get_as_string() { return nativeGetAsString( mNativePtr ); }
